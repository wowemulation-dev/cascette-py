...
| 41030 | 1.14.1 | wow_classic_era | wow_classic_era | Y | Y | Nov 11, 2021 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
...
| 41794 | 1.14.1 | wow_classic_era | wow_classic_era | Y | Y | Jan 10, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 42032 | 1.14.1 | wow_classic_era | wow_classic_era | Y | Y | Feb 1, 2022 — A2 target | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 42214 | 1.14.2 | wow_classic_era | wow_classic_era | Y | Y | Feb 8, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 42597 | 1.14.2 | wow_classic_era | wow_classic_era | Y | Y | Mar 5, 2022 — A2 target | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 43401 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | May 3, 2022 — A1 target | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 44016 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Jun 7, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 44170 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Jun 15, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 44403 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Jun 30, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 44834 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Jul 27, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 46575 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Nov 9, 2022 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 47658 | 1.14.3 | wow_classic_era | wow_classic_era | Y | – | Jan 17, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 48611 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Mar 20, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 49229 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | Apr 21, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-17) |
| 49821 | 1.14.3 | wow_classic_era | wow_classic_era | Y | Y | May 30, 2023 — A1 target | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
| 51001 | 1.14.4 | wow_classic_era | wow_classic_era | Y | – | Aug 18, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
| 51056 | 1.14.4 | wow_classic_era | wow_classic_era | Y | – | Aug 23, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
| 51146 | 1.14.4 | wow_classic_era | wow_classic_era | Y | Y | Aug 29, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
| 51311 | 1.14.4 | wow_classic_era | wow_classic_era | Y | – | Sep 11, 2023 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
...
| 53181 | 1.15.1 | wow_classic_era | wow_classic_era | Y | – | Feb 1, 2024 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
...
| 54029 | 1.15.2 | wow_classic_era | wow_classic_era | Y | – | Apr 1, 2024 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
...
| 55515 | 1.15.3 | wow_classic_era | wow_classic_era | Y | Y | Jul 8, 2024 | ✅ format+container scan + client 1-run, 0 CDN requests (2026-08-18) |
